...
public class UseInFragmentActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBottomNavigationBar.addItem(new BottomNavigationItem(R.drawable.ic_favorite, "我的"))
            .addItem(new BottomNavigationItem(R.drawable.ic_gavel, "上家"))
            .addItem(new BottomNavigationItem(R.drawable.ic_grade, "下架"))
            .addItem(new BottomNavigationItem(R.drawable.ic_group_work, "好吧"))
            .initialise();
